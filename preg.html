...
<head>
	<!-- Meta tags -->
	<title>Daily Application Form </title>
...
<body  background="f7499c1d692de2f8fab3f42e5e4e6fd4.jpg"  background="no-repeat" background="center">
	<div class="w3ls-banner">
	<div class="heading">
		<h1>Daily Application Form</h1>
	</div>
		<div class="container">
			<div class="heading">
				...
				<form action="#" method="post">
					<ul class="field-list">
						...
						<li> 
							...
							<div class="form-input">
								<input type="Text" name="Adhaar number" placeholder="Enter number" required>
						...
						<li>
							<label class="form-label"> Work Area <span class="form-required"> * </span></label>
							<div class="form-input">
								<select class="form-dropdown" name="Work Area" required>
